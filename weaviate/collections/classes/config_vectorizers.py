...
VoyageModel: TypeAlias = Literal[
    # Current models (see https://docs.voyageai.com/docs/embeddings)
    "voyage-4-large",
    "voyage-4",
    "voyage-4-lite",
    "voyage-4-nano",
...
class Vectorizers(str, Enum):
    ...
    Attributes:
        ...
        MULTI2VEC_VOYAGEAI: Weaviate module backed by a VoyageAI by MongoDB multimodal embedding models.
